...
project = u'edX 開始使用 Studio'
copyright = u'2014, EdX Doc Team, revised by edX PDR Lab of NCU, Taiwan'
...
texinfo_documents = [
  ('index', 'getting_started_zhTW', u'getting_started Documentation',
   u'edX PDR Lab', 'getting_started', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2014, edX 平台開發研究實驗室'
